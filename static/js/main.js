(() => {
  ...
  function w(n2, l2, u2, i2, t2, o2, r2, f2, s2, a3) {
    ...
    for (u2.__k = [], h2 = 0; h2 < l2.length; h2++)
      if ((_2 = u2.__k[h2] = (_2 = l2[h2]) == null || typeof _2 == "boolean" ? null : typeof _2 == "string" || typeof _2 == "number" || typeof _2 == "bigint" ? y(null, _2, null, null, _2) : Array.isArray(_2) ? y(d, { children: _2 }, null, null, null) : _2.__b > 0 ? y(_2.type, _2.props, _2.key, null, _2.__v) : _2) != null) {
        ...
        j(n2, _2, p = p || e, t2, o2, r2, f2, s2, a3), b2 = _2.__e, (v2 = _2.ref) && p.ref != v2 && (g2 || (g2 = []), p.ref && g2.push(p.ref, null, _2), g2.push(v2, _2.__c || b2, _2)), b2 != null ? (m2 == null && (m2 = b2), typeof _2.type == "function" && _2.__k === p.__k ? _2.__d = s2 = x(_2, s2, n2) : s2 = P(n2, _2, p, w2, b2, s2), typeof u2.type == "function" && (u2.__d = s2)) : s2 && p.__e == s2 && s2.parentNode != n2 && (s2 = k(p));
      }
  ...
  function L(l2, u2, i2, t2, o2, r2, f2, c2) {
    var s2, a3, v2, y2 = i2.props, p = u2.props, d2 = u2.type, _2 = 0;
    ...
    if (d2 === null)
      ...
      if (r2 = r2 && n.call(l2.childNodes), a3 = (y2 = i2.props || e).dangerouslySetInnerHTML, v2 = p.dangerouslySetInnerHTML, !c2) {
        if (r2 != null)
  ...
  // static/ts/actions.ts
  var a2 = {
    addPost: async (body) => {
      await callApi("posts", "POST", { id: 0, body });
      window.location.reload();
    },
    updatePost: async (post) => {
      await callApi(`posts/${post.id}`, "PUT", post);
      window.location.reload();
    },
    removePost: async (id) => {
      if (confirm("Are you sure?")) {
        await callApi(`posts/${id}`, "DELETE", { id, body: "" });
        window.location.reload();
      }
    },
    addEvent: async (title, body, date) => {
      await callApi("events", "POST", { id: 0, title, body, date });
      window.location.reload();
    },
    updateEvent: async (event) => {
      await callApi(`events/${event.id}`, "PUT", event);
      window.location.reload();
    },
    removeEvent: async (id) => {
      if (confirm("Are you sure?")) {
        await callApi(`events/${id}`, "DELETE", { id, title: "", body: "", date: "" });
        window.location.reload();
      }
    },
    updateSite: async (site) => {
      await callApi(`sites/${site.id}`, "PUT", site);
      window.location.reload();
    },
    addPage: async (title, body) => {
      await callApi("pages", "POST", { id: 0, title, body });
      window.location.reload();
    },
    updatePage: async (page) => {
      await callApi(`pages/${page.id}`, "PUT", page);
      window.location.reload();
    },
    removePage: async (id) => {
      if (confirm("Are you sure?")) {
        await callApi(`pages/${id}`, "DELETE", { id, title: "", body: "" });
        window.location.href = "/";
      }
    }
  };
  var actions_default = a2;

  // static/ts/cmp/AddEvent.tsx
  function AddEvent(props) {
    return /* @__PURE__ */ v(d, null, /* @__PURE__ */ v("form", {
      action: "/api/events",
      method: "post",
      id: "event-add-form"
    }, /* @__PURE__ */ v("input", {
  ...
  // static/ts/cmp/AddPage.tsx
  function AddPage(props) {
    return /* @__PURE__ */ v("div", {
      class: "page-add"
    }, /* @__PURE__ */ v("h2", null, "Add page"), /* @__PURE__ */ v("form", {
      action: "/api/pages",
      method: "post",
      id: "post-add-form"
    }, /* @__PURE__ */ v("input", {
      ...
      type: "text",
      name: "Slug",
      placeholder: "slug, without the leading /"
    }), /* @__PURE__ */ v("input", {
      class: "input",
      type: "text",
      name: "Title",
  ...
  // static/ts/cmp/AddPageButton.tsx
  ...
  var AddPageButton_default = AddPageButton;

  // static/ts/cmp/AddPost.tsx
  ...
  // static/ts/cmp/AdminControls.tsx
  function AdminControls(props) {
    return /* @__PURE__ */ v(d, null, /* @__PURE__ */ v("a", {
      href: "#",
      onClick: props.toggleEdit
    }, /* @__PURE__ */ v("i", {
      class: "fa fa-pencil",
      "aria-hidden": "true"
    })), props.hasRemove && /* @__PURE__ */ v("a", {
      href: "#",
      onClick: props.onRemove
    }, /* @__PURE__ */ v("i", {
      class: "fa fa-trash",
      "aria-hidden": "true"
    })), props.hasImage && /* @__PURE__ */ v("a", {
      href: "#",
  ...
  var AdminControls_default = AdminControls;

  // static/ts/cmp/SubmitCancel.tsx
  ...
  var SubmitCancel_default = SubmitCancel;

  // static/ts/newElement.ts
  function ne(type, attributes, parentNode, children, options) {
  ...
  var newElement_default = ne;

  // static/ts/makeEditable.tsx
  function makeEditable(editableElements, controlRoot, id, onRemove, onSubmit) {
    function submit() {
      console.log("submit");
      const values = {};
    ...
    function handleToggleEdit() {
      for (const key in editableElements) {
        ...
        if (el.isContentEditable) {
          ...
          el.blur();
          S(/* @__PURE__ */ v(AdminControls_default, {
          ...
          el.focus();
          S(/* @__PURE__ */ v(SubmitCancel_default, {
            onSubmit: submit,
    ...
    const controls = newElement_default("div", { class: "controls" }, controlRoot, null);
    S(/* @__PURE__ */ v(AdminControls_default, {
      toggleEdit: handleToggleEdit,
      hasRemove: true,
      onRemove: remove
  ...
  var makeEditable_default = makeEditable;
  ...
  function makePostsEditable() {
    ...
    posts.forEach((post) => {
      ...
      makeEditable_default({ body }, post, id, actions_default.removePost, actions_default.updatePost);
    });
  }
  function makeEventsEditable() {
    ...
    events.forEach((event) => {
      ...
      makeEditable_default({ body, title }, event, id, actions_default.removeEvent, actions_default.updateEvent);
    });
  }
  function makeHeaderEditable() {
    ...
    makeEditable_default({ title, description }, header, siteId, null, actions_default.updateSite);
  }
  function makePageEditable() {
    ...
    makeEditable_default({ title, body }, page, id, actions_default.removePage, actions_default.updatePage);
  }
  function renderAddPostForm() {
    ...
    const addPostWrapper = newElement_default("div", { class: "post-add card" }, posts, null, { prepend: true });
    S(/* @__PURE__ */ v(AddPost_default, null), addPostWrapper);
  }
  function renderAddEventForm() {
    ...
    const addEventWrapper = newElement_default("div", { class: "event-add card" }, events, null, {
      prepend: true
    });
    S(/* @__PURE__ */ v(AddEvent_default, null), addEventWrapper);
  }
  function renderAddPageForm() {
    ...
    main.innerHTML = "";
    S(/* @__PURE__ */ v(AddPage_default, null), main);
  }
  function renderAddPageButton() {
    ...
    const addPageButton = newElement_default("div", { class: "add-page-button" }, menu, null);
    S(/* @__PURE__ */ v(AddPageButton_default, {
      onClick: renderAddPageForm
    }), addPageButton);
  }
